// Preloader
  ...
  $(window).load(function(){
        $('.loader').delay(2*1000).fadeOut();    
        $('#preloader').delay(2*1000).fadeOut('slow');    
        $('body').delay(2*1000);   
...
jQuery(document).ready(function($) {
    ...
    $("#1-slides").owlCarousel({
        items: 1
    });
	 
	 $("#2-slides").owlCarousel({
        items: 1
    });
	 $("#3-slides").owlCarousel({
        items: 1
    });
	 $("#4-slides").owlCarousel({
        items: 1
    });
	$("#5-slides").owlCarousel({
        items: 1
    });
	$("#6-slides").owlCarousel({
        items: 1
    });
	$("#7-slides").owlCarousel({
        items: 1
    });
	$("#8-slides").owlCarousel({
        items: 1
    });
	
	$("#9-slides").owlCarousel({
        items: 1
    });
    $("#10-slides").owlCarousel({
        items: 1
    });
